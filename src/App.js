...
function App() {
    ...
    //console.log(groks.getPattern("WORD"))
    ...
    const defaultCollections = [
        ...
        {value: "httpd", label: "Httpd", active: true},
    ...
    const handleParse = async () => {
        try {
            ...
            let matchedCount = output.reduce((acc, val) => (acc += +(val !== null)), 0)
                ...
                <div className="menu">
                    <div className="collections-wrapper">
                        ...
                        <div style={{marginTop: 10}}>
                            <a href="https://github.com/cjslack/grok-debugger/tree/master/public/patterns"
                               target="_blank">
                ...
                <div className="result">
                    <div className="output-wrapper">
                        <div className="output-top">
                            ...
                            <div
                                className={`counter ${!sampleCount ? "" : matchCount === sampleCount ? "all-match" : "no-match"}`}>
